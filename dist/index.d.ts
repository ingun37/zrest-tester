...
export declare function generateAndSaveSrestAnswers(sresturls: string[], destination: string, libURL: URL, waitTimeMS: number): TE.TaskEither<void, void>;
...
export declare function testSrestLibrary(libURL: URL, sresturls: string[], answersDir: string, debugImageDir: string, waitTimeMS: number): TE.TaskEither<void, number>;
